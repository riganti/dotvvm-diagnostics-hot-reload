...
namespace DotVVM.Framework.Configuration
{
    public static class DotvvmServiceCollectionExtensions
    {
        ...
        private static void RegisterResources(DotvvmConfiguration config, DotvvmViewHotReloadOptions options)
        {
            ...
            config.Resources.Register("dotvvm-viewhotreload", new ScriptResource(new EmbeddedResourceLocation(typeof(DotvvmServiceCollectionExtensions).Assembly, "Dotvvm.ViewHotReload.Owin.Scripts.dotvvm.viewhotreload.js"))
            {
